...
public class CleverTapUnity: MonoBehaviour {
    ...
    void Awake(){
        ...
        //==========[Testing Newly added Clevertap APIs]============================================
            ...
            CleverTapBinding.CreateNotificationChannel("UnityChannel", "UnityChannel", "Unity Notification Channel", 5, true);
        
        // reset the user profile after a login with a new Identity
        Dictionary<string, string> newProps = new Dictionary<string, string>();
        newProps.Add("email", "unity@test.com");
        newProps.Add("Identity", "925720");
